    ...
    return (
        <div className="w-100 px-5 flex justify-center items-center min-h-screen bg-gradient-to-r from-purple-700 to-purple-500">
            <div>
                ...
                src={error404Img} 
                alt="404ErrorImg"
                className="w-[450] max-sm:w-[290px] m-auto"
                />
                ...
                <div className="text-center mt-4">
                    <Link to={"/"}>
                    <button className="flex group items-center gap-2 m-auto py-3 px-5 text-purple-500 font-semibold bg-amber-500 rounded-full hover:bg-purple-900 duration-300 hover:text-white max-sm:text-sm">
